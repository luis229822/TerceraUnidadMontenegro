...
<div class="max-w-7xl mx-auto py-6 px-0">
    <h1 class="text-2xl font-bold text-center text-gray-800 mb-6">Consulta de Áreas</h1>
    ...
    <div id="areas-table" class="overflow-x-auto">
        @include('profile.partials.areas-table')
    </div>
</div>
    ...
    function fetchData(search = '', page = 1) {
        $.ajax({
            ...
            success: function (response) {
                $("#areas-table").html(response.html);
